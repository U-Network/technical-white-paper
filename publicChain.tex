...
%{\color{red} note: discuss how do we achieve to confirm a transactions as fast as 6 seconds and could concurrently process up to 3000 transactions per second}
...
%{\color{red} note: discuss how make users' votes sequential along the time, so earlier vote get paid from the latter's payment}
